...
CreateArrayRandomNumbers(numbers);
Console.WriteLine();
...
Console.WriteLine($"Наименьшая сумма в {(indexLine)} строке , сумма ее элементов равна {(minsum)}");
...
CreateArrayRandomNumbers(matrixA);
CreateArrayRandomNumbers(matrixB);
